...
const mobileButton = document.querySelector('.menu-btn'),
      mobileMenu = document.querySelector('.mm-ocd.mm-ocd--left'),
      mobileMenuClose = document.querySelector('#mmmenu-close-button')

mobileButton.addEventListener('click', () => {
  mobileMenu.classList.add('mm-ocd--open')
})
mobileMenuClose.addEventListener('click', () => {
  mobileMenu.classList.remove('mm-ocd--open')
})